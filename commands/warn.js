...
module.exports = {
    ...
    execute: async (bot, message, args) => {
        ...
        if (!args[0]) return message.channel.send("Please Enter A **User** to Warn!")
        ...
        if (!target) return message.channel.send("Please Enter A **User** to Warn!")
        ...
        if (target.hasPermission("MANAGE_GUILD") || target.user.bot) return message.channel.send("I Cannot Warn This **User**... May be the user is a moderator or admin!")
      try {
